      ...
      <div className="home-container">
        <div className="hero-section">
          <div className="hero-content">
            ...
            <p>
              Enjoy the convenience of online shopping and the assurance of
              fresh, top-quality products every time. Experience AgroMobile
              today!
            </p>
        ...
        <div className="arc-image">
          ...
          />
          <p>
            Leveraging Artificial Intelligence (AI) to enhance user experience
        ...
        <div className="locals-section animate-on-scroll">
          ...
          <p>
            We take pride in partnering with numerous local farms and artisans
            who supply us with an amazing variety of food throughout the year
          </p>
